 ...
 *  File: ContinuingEducationDetail.ascx.cs
 *
 *  Accela, Inc.
 *  Copyright (C): 2013
 *
...
{
    /// <summary>
    /// Continuing education detail page
    /// </summary>
    public partial class ContinuingEducationDetail : BaseUserControl
    {
        /// <summary>
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(agencyCode) && !string.IsNullOrEmpty(eduId))
            {
                ...
                ContinuingEducationModel contEducation =
                    licenseCertificationBll.GetContEducationModelByPK(new ContinuingEducationPKModel()
                        {
                ...
                lblRequire.Value = ModelUIFormat.FormatYNLabel(contEducation.requiredFlag);
