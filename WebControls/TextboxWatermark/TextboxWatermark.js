...
* 
*  Notes:
* $Id: TextboxWatermark.js 171222 2010-04-23 17:32:00Z ACHIEVO\alan.hu $.
*  Revision History
*  &lt;Date&gt;,    &lt;Who&gt;,    &lt;What&gt;
* </pre>
*/
...
AjaxControlToolkit.TextBoxWatermarkBehavior = function(element) {
    ...
    //this._oldClassName = null;//Unused.
...
AjaxControlToolkit.TextBoxWatermarkBehavior.prototype = {
    initialize: function() {
        ...
        //this._oldClassName = e.className;//Unused.
    ...
    _onFocus: function(evt) {
        ...
        Sys.UI.DomElement.removeCssClass(e, this._watermarkCssClass);
    ...
    _onBlur: function() {
        ...
        /*                    
        * Scenario: In Chrome,Safari,Opera,the ValidatedControlOnBlur event in the base Required Validator library will be executed before this method
        *   and in the ValidatedControlOnBlur method code,it will refocus on the hosted input element.
        *   so in this method, need recall the blur method of the hosted input element to resolve the bug: #48396.
        */
        if (typeof (this.get_element().blur) != "undefined") {
    ...
    _applyWatermark: function() {
        ...
        wrapper.set_Watermark(this._watermarkText);
        wrapper.set_IsWatermarked(true);
        if (this._watermarkCssClass && !Sys.UI.DomElement.containsCssClass(this.get_element(), this._watermarkCssClass)) {
            Sys.UI.DomElement.addCssClass(this.get_element(), this._watermarkCssClass);
        }
    },
