 ...
 *
 *  Notes:
 *      $Id: ProgressBar.aspx.cs 170366 2010-09-08 05:34:25Z ACHIEVO\daly.zeng $.
 *  Revision History
 *  &lt;Date&gt;,    &lt;Who&gt;,    &lt;What&gt;
 * </pre>
 */
...
namespace Brettle.Web.NeatUpload
{
	...
	public class ProgressBar : System.Web.UI.WebControls.WebControl
	{
		...
		private void InitializeVars()
		{
			...
			{
                uploadProgressUrl = appPath + "/FileUpload/Progress.aspx";
			}
...
");
		...
		protected override void Render(HtmlTextWriter writer)
		{
            ...
            // add innerHTML between iframe --james.shi
            if (!IsDesignTime)
            {
