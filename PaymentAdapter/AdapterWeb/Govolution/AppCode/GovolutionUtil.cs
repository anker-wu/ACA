 ...
 *
 *  Notes:
 * $Id: GovolutionUtil.cs 135124 2009-08-17 06:01:11Z ACHIEVO\cary.cao $.
 *  Revision History
 *  &lt;Date&gt;,    &lt;Who&gt;,    &lt;What&gt;
 * </pre>
 */
...
namespace Accela.ACA.PaymentAdapter.GovolutionAdapter
{
    ...
    public class GovolutionUtil
    {
        ...
        private static string GetCardType(object paymentType)
        {
            ...
            else if (cardType == "2" || cardType == "3")// 1: credit card; 2,3:check
            {
                return "Check";
            }
            else
