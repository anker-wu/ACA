<%@ Page Language="C#" AutoEventWireup="true" Inherits="Payment_GoToPayment" Codebehind="GoToPayment.aspx.cs" %>
...
<head runat="server">
    <title><%=LabelUtil.GetGlobalTextByKey("aca_gotopayment_label_title|tip")%></title>
</head>
<body>
