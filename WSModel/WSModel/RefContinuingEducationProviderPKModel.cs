...
namespace Accela.ACA.WSProxy
{
    ...
    public partial class RefContinuingEducationProviderPKModel
    {
        ...
        private bool providerNbrFieldSpecified;

        private long refContEduNbrField;

        private bool refContEduNbrFieldSpecified;
        ...
        public bool providerNbrSpecified
        {
            get
            {
                return this.providerNbrFieldSpecified;
            }
            set
            {
                this.providerNbrFieldSpecified = value;
            }
        }
        ...
        /// <remarks/>
        [System.Xml.Serialization.XmlIgnoreAttribute()]
        public bool refContEduNbrSpecified
        {
            get
            {
                return this.refContEduNbrFieldSpecified;
            }
            set
            {
                this.refContEduNbrFieldSpecified = value;
            }
        }
