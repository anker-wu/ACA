 ...
 * 
 *  Notes:
 *      $Id: ext-all-debug.js 77905 2007-10-15 12:49:28Z ACHIEVO\lytton.cheng $.
 *  Revision History
 *  &lt;Date&gt;,    &lt;Who&gt;,    &lt;What&gt;
 * </pre>
*/
...
Ext.tree.TreeNodeUI.prototype = {
    ...
    updateExpandIcon : function(){
        if(this.rendered){
            ...
            //Support section 508, fix the img won't display issue in high contrast.
            if (typeof (getAppRoot) == 'function' && n.ownerTree) {
                if (n.ownerTree.useArrows) {
                    ;
                } else if (n.ownerTree.lines) {
                    if (this.ecNode.className.indexOf('x-tree-elbow') > -1) {
                        this.ecNode.src = getAppRoot() + 'Admin/resources/images/default/tree/elbow.gif';
                    }
                    if (this.ecNode.className.indexOf('x-tree-elbow-plus') > -1) {
                        this.ecNode.src = getAppRoot() + 'Admin/resources/images/default/tree/elbow-plus.gif';
                    }
                    if (this.ecNode.className.indexOf('x-tree-elbow-minus') > -1) {
                        this.ecNode.src = getAppRoot() + 'Admin/resources/images/default/tree/elbow-minus.gif';
                    }
                    if (this.ecNode.className.indexOf('x-tree-elbow-end') > -1) {
                        this.ecNode.src = getAppRoot() + 'Admin/resources/images/default/tree/elbow-end.gif';
                    }
                    if (this.ecNode.className.indexOf('x-tree-elbow-end-plus') > -1) {
                        this.ecNode.src = getAppRoot() + 'Admin/resources/images/default/tree/elbow-end-plus.gif';
                    }
                    if (this.ecNode.className.indexOf('x-tree-elbow-end-minus') > -1) {
                        this.ecNode.src = getAppRoot() + 'Admin/resources/images/default/tree/elbow-end-minus.gif';
                    }
                    if (this.ecNode.className.indexOf('x-tree-elbow-line') > -1) {
                        this.ecNode.src = getAppRoot() + 'Admin/resources/images/default/tree/elbow-line.gif';
                    }
                } else {
                    if (this.ecNode.className.indexOf('x-tree-elbow-plus') > -1) {
                        this.ecNode.src = getAppRoot() + 'Admin/resources/images/default/tree/elbow-plus-nl.gif';
                    }
                    if (this.ecNode.className.indexOf('x-tree-elbow-minus') > -1) {
                        this.ecNode.src = getAppRoot() + 'Admin/resources/images/default/tree/elbow-minus-nl.gif';
                    }
                    if (this.ecNode.className.indexOf('x-tree-elbow-end-plus') > -1) {
                        this.ecNode.src = getAppRoot() + 'Admin/resources/images/default/tree/elbow-end-plus-nl.gif';
                    }
                    if (this.ecNode.className.indexOf('x-tree-elbow-end-minus') > -1) {
                        this.ecNode.src = getAppRoot() + 'Admin/resources/images/default/tree/elbow-end-minus-nl.gif';
                    }
                }
            }
        }
                ...
                if(!p.isRoot || (p.isRoot && p.ownerTree.rootVisible)){
                    if(!p.isLast()) {
                        ...
                        if (typeof (getAppRoot) == 'function') {
                            buf.unshift('<img src="' + getAppRoot() + 'Admin/resources/images/default/tree/elbow-line.gif' + '" class="x-tree-elbow-line" />');
                        } else {
