...
namespace Accela.ACA.WSProxy
{
    ...
    public partial class ProcessRelationModel4WS
    {
        ...
        private long parentProcessIDField;
        ...
        private string subflowCompletionReqField;

        private string taskActivationField;
        ...
        /// <remarks/>
        [System.Xml.Serialization.XmlElementAttribute(Form = System.Xml.Schema.XmlSchemaForm.Unqualified)]
        public string subflowCompletionReq
        {
            get
            {
                return this.subflowCompletionReqField;
            }
            set
            {
                this.subflowCompletionReqField = value;
            }
        }

        /// <remarks/>
        [System.Xml.Serialization.XmlElementAttribute(Form = System.Xml.Schema.XmlSchemaForm.Unqualified)]
        public string taskActivation
        {
            get
            {
                return this.taskActivationField;
            }
            set
            {
                this.taskActivationField = value;
            }
        }
