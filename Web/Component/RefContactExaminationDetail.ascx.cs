 ...
 *  File: RefContactExaminationDetail.ascx.cs
 *
 *  Accela, Inc.
 ...
 *
 *  Notes:
 *      $Id: RefContactExaminationDetail.ascx.cs 238264 2012-11-20 08:31:18Z ACHIEVO\alan.hu $.
 *  Revision History
 *  &lt;Date&gt;,    &lt;Who&gt;,    &lt;What&gt;
 * </pre>
 */
...
namespace Accela.ACA.Web.Component
{
    ...
    /// </summary>
    public partial class RefContactExaminationDetail : BaseUserControl
    {
        /// <summary>
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string passingScore = examination.passingScore.HasValue ? examination.passingScore.ToString() : string.Empty;
            lblPassScore.Value = EducationUtil.FormatScore(examination.gradingStyle, passingScore, true);
